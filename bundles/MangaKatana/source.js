...
var _Sources = (() => {
  ...
  var MangaKatana_exports = {};
  __export(MangaKatana_exports, {
    default: () => MangaKatana
  });
  var import_types = __toESM(require_lib());

  // src/MangaKatana/MangaKatanaParser.ts
  var MangaKatanaParser = class {
    parseChapterDetails(html) {
  ...
  // src/MangaKatana/MangaKatana.ts
  var MK_DOMAIN = "https://mangakatana.com";
  var MangaKatana = class extends import_types.Source {
    constructor() {
      super(...arguments);
